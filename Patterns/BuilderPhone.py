...
class Employee:  # Абстрактный класс
    def build_accumulator(self, capacity):  # Абстрактные методы
...
class Telephone:
    def __init__(self, id, date_create, price, accumulator, screen, processor, memory, microphone):
        self.ID = id  # Свойства телефона
        self.date_create = date_create  # Свойства телефона
        self.price = price  # Свойства телефона
        self.accumulator = accumulator  # Объект аккумулятор
        self.screen = screen  # Объект экран
        self.processor = processor  # Объект процессор
        self.memory = memory  # Объект память
        self.microphone = microphone  # Объект микрофон
...
samsung = Oleg.create_telephone(72284, "10.10.2022", 14000,  # Свойства телефона
                                3400,  # Емкость аккумулятора
                                [16, 8], "OLED",  # Экран
                                "Snapdragon 400",  # Процессор
                                512,  # Память
                                [14, 16000]  # Микрофон
                                )
