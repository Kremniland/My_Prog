...
#  выводить на экран список в виде строки из чисел, разделенных пробелами и принадлежащие
...
class Graph:
    ...
    def set_data(self, data):
        self.data = data
    def draw(self):
        print(' '.join(map(str, filter(lambda i: i >= self.LIMIT_Y[0] and i <= self.LIMIT_Y[1], self.data))))


graph_1 = Graph()
lst_1 = graph_1.set_data([10, -5, 100, 20, 0, 80, 45, 2, 5, 7])
graph_1.draw()